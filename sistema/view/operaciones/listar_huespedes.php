...
<html>
  <head>
    ...
    <script src="../../js/listar_huespedes.js"></script>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">       
        ...
        <div class='box'>
          <div id="cabecera">
              <div class="row"><br>
                <center><h1 class="box-title"><strong>LISTA DE HUÉSPEDES</strong></h1></center><br>
              </div>
              <input type="button" id="new_huesped" class="btn btn-success letra col-md-offset-1" value="Nuevo"/>
              <div class="row">
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size: 12px; height: 10px; width: 15%;">Apellido Paterno</th>
                                    <th style="font-size: 12px; height: 10px; width: 15%;">Apellido Materno</th>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title text-center letra1" id="cabeceraRegistro"><b>Nuevo Huesped</b></h4>
                        </div>
                        ...
                        <form action="" method="POST" class="form-horizontal" id="form_nuevoUsuario">   
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label for="nombreEmpresa" class="col-md-4 control-label">DNI O PASAPORTE</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control" type="text" id="param_celular" name="param_celular" placeholder="Ingrese celular">
                                    </div>
                                </div>

                                 <div class="form-group">
                                    <label for="ruc" class="col-md-4 control-label">Empresa</label>
                                    <div class="col-md-7">
                                        <select class="form-control" type="text" id="param_empresa" name="param_empresa" placeholder="Seleccione Empresa">
                                         
                                        </select>
                                    </div>
                                </div>
                                <input type="hidden" value="nuevoUsuario" name="param_usuario" id="param_usuario">
                                <input type="hidden" value="nuevoUsuario" name="param_clave" id="param_clave">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a >Hotel ROCEVIB dddd- Trujillo</a>.</strong> All rights reserved.
      </footer>
    </div><!-- ./wrapper -->
